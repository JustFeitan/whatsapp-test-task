...
const ErrorSendMessageIcon: FC<IconInterface> = ({size, ...props}) => {
    return (
        <Icon icon={
            <svg
                version="1.1"
...
export default ErrorSendMessageIcon;
